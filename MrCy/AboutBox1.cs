...
namespace MrCy
{
    partial class AboutBox1 : Form
    {
        ...
        private void AboutBox1_Load(object sender, EventArgs e)
        {
            ...
            this.labelVersion.Text = String.Format("版本 {0}", "  1.0.0.0");
            this.labelCopyright.Text = "版本所有";
            this.labelCompanyName.Text = "任何人，";
            this.textBoxDescription.Text = "自己学习开发，任何人有权使用";
        }
